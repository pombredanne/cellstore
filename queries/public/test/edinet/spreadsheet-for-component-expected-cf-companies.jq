    ...
    "TableSet": [
        {
            "TableHeaders": {
                "x": [
                    ...
                    {
                        "GroupLabels": [
                            "FSA Submission Date [Axis] breakdown"
                        ],
                        "GroupCells": [
                            [
                                {
                                    "CellLabels": [
                                        "FSA Submission Date [Axis]"
                                    ],
                                    "CellConstraints": {},
                                    "TagSelectors": [],
                                    "CellSpan": 4,
                            ...
                            [
                                {
                                    "CellLabels": [
                                        "四半期連結キャッシュ・フロー計算書関係",
                                        "jpcrp-cor:NotesQuarterlyConsolidatedStatementOfCashFlowsHeading"
                                    ],
                                    "CellConstraints": {
                                        "": {
                            ...
                            [
                                {
                                    "CellLabels": [
                                        "四半期連結キャッシュ・フロー計算書関係",
                                        "jpcrp-cor:NotesQuarterlyConsolidatedStatementOfCashFlowsTable"
                                    ],
                                    "CellConstraints": {
                                        "": {
                                ...
                                },
                                {
                                    "CellLabels": [
                                        "四半期連結キャッシュ・フロー計算書関係",
                                        "jpcrp-cor:NotesQuarterlyConsolidatedStatementOfCashFlowsLineItems"
                                    ],
                                    "CellConstraints": {
                                        "": {
                                ...
                                },
                                {
                                    "CellLabels": [
                                        ...
                                        "jpcrp-cor:DescriptionOfFactThatQuarterlyStatementOfCashFlowsHasNotBeenPreparedTextBlock"
                                    ],
                                    "CellConstraints": {
                                        "": {
                                ...
                                },
                                {
                                    "CellLabels": [
                                        ...
                                        "jpcrp-cor:ReconciliationOfEndingBalanceOfCashAndCashEquivalentsWithAccountBalancesPerBalanceSheetTextBlock"
                                    ],
                                    "CellConstraints": {
                                        "": {
