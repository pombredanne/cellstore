...
(:
  Retrieves the standard presentation network in one of the components of one of the filings by Walt Disney.
:)
...
return networks:networks-for-components-and-short-names($component, $networks:PRESENTATION_NETWORK)
